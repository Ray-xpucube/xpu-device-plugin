...
const (
	...
	countName            = "yoyoworks.com/xpu-core"
	...
	pluginComponentValue = "xpu-device-plugin"

	envNVGPUID             = "YOYOWORKS_XPU_SHARES_INDEX"
	envPodGPUMemory        = "YOYOWORKS_XPU_SHARES_POD"
	envTOTALGPUMEMORY      = "YOYO_XPU_SHARES"
	gpushareAllocationFlag = "scheduler.framework.xpu.allocation"
)
